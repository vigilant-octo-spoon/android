...
public class LoginActivity extends AppCompatActivity {
    ...
    public AuthorizeUser mUserAuth = null;
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(email)) {
            mEmailView.setError(getString(R.string.no_email_entered));
            focusView = mEmailView;
            cancel = true;
        }
        if (TextUtils.isEmpty(password)) {
            mPasswordView.setError(getString(R.string.no_password_entered));
        ...
        if (cancel) {
            ...
            showProgress(true);
            mUserAuth = new AuthorizeUser(vosDB, email, password, this, this);
            mUserAuth.execute();
        }
    }
